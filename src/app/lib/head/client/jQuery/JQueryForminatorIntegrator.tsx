...
//TODO
import "path/to/jquery.inputmask.min.js";
import "path/to/jquery.validate.min.js";
export default function JQueryForminatorIntegrator(): JSX.Element {
  const initializeForminatorModule = (moduleId: number): void => {
    ...
    const runForminatorFront = (): JQuery<HTMLElement> =>
      $(
    ...
    typeof window.ForminatorFormNewTabRedirect !== "undefined" &&
      window.open(window.ForminatorFormNewTabRedirect.url, "_blank");
  };
  useEffect(() => {

export default function loadFlatsomeLiveSearch(jQuery) {
  !(function (t) {
    function e(e) {
                          ...
                          t.each(s.axis.split(""), function (t, n) {
                            ...
                            if (c)
                              (p[r] = c[o] + (u ? 0 : a - f.offset()[o])),
                                s.margin &&
                                  ((p[r] -=
                                    parseInt(h.css("margin" + i), 10) || 0),
                                  (p[r] -=
                                    parseInt(
                                      h.css("border" + i + "Width"),
                                      10
                                    ) || 0)),
                                (p[r] += y[o] || 0),
                                s.over[o] &&
              ...
              (t = {
                ...
                for (var s in this.waypoints[r]) {
                  ...
                  f.element !== f.element.window &&
                    (y = f.adapter.offset()[a.offsetProp]),
                    "function" == typeof h
                      ? (h = h.apply(f))
                      : "string" == typeof h &&
                        ((h = parseFloat(h)),
                    ...
                    (d = !c && !u),
                    !g && c && u
                      ? (f.queueTrigger(a.backward), (o[f.group.id] = f.group))
                      : ((!g && d) || (g && a.oldScroll >= f.triggerPoint)) &&
                        (f.queueTrigger(a.forward), (o[f.group.id] = f.group));
                }
              }
              return (
            ...
            (o.prototype.flushTriggers = function () {
              for (var n in this.triggerQueues) {
                ...
                for (var r = 0, a = i.length; r < a; r += 1) {
                  var s = i[r];
                  (s.options.continuous || r === i.length - 1) &&
                    s.trigger([n]);
                }
              }
              this.clearTriggerQueues();
        ...
        t.Flatsome = {
                  ...
                  return (
                    this.each(function () {
                      if (
                        ...
                        "function" != typeof jQuery.data(this, "plugin_" + t)[a]
                      )
                        throw new Error(
                          "Method " + a + " does not exist on jQuery." + t
                        );
          ...
          attach: function (t) {
            ...
            for (var n in this.behaviors)
              "function" == typeof this.behaviors[n].attach &&
                this.behaviors[n].attach(e || document);
          },
          detach: function (t) {
            var e =
              arguments.length > 1 && void 0 !== arguments[1]
            ...
            if ("string" == typeof t)
              return this.behaviors.hasOwnProperty(t) &&
                ...
                : null;
            for (var n in this.behaviors)
              "function" == typeof this.behaviors[n].detach &&
                this.behaviors[n].detach(e || document);
          },
        };
      }).call(this, n(2));
    },
          ...
          (function (t) {
            ...
            if (!(f.top > r || f.top + a.offsetHeight < 0))
              switch (i) {
                case "backgroundImage":
                  (v = f.top * o),
                    (n.style.backgroundPosition = o
                      ? "50% ".concat(v.toFixed(0), "px")
                      : null),
                ...
                case "backgroundElement":
                  (v = y * o - c / 2),
                    (n.style.transform = o
                      ? "translate3d(0, ".concat(v.toFixed(2), "px, 0)")
                      : null),
                ...
                case "element":
                  (v = g * o),
                    (n.style.transform = o
                      ...
                      : null),
                    (n.style.backfaceVisibility = o ? "hidden" : null),
                    void 0 !== n.dataset.parallaxFade &&
                      (n.style.opacity = o
                        ? ((e = 1 - m), e * (2 - e)).toFixed(2)
                        : null);
              }
          })(t);
      }
            ...
            (function (e) {
              ...
              if (c && !l) {
                ...
                p > g && p < y && (m = (p + g) / 3),
                  g < 0 && (m = -g),
                  m && u
                    ? n.css("margin-right", -m)
                    : m && n.css("margin-left", -m),
                    ...
                    r(
                      r(
                        r(
                          ...
                          !u && {
                            width: l
                              ? Q - o.get(0).getBoundingClientRect().right
                              : Q,
                          }
                        ),
                        u && {
              ...
              if ((s || a) && !l) {
                ...
                if (
                  (o.closest("#top-bar").length &&
                    (x = document.querySelector("#top-bar")),
                  o.closest("#masthead").length &&
                    (x = document.querySelector("#masthead")),
                  o.closest("#wide-nav").length &&
                    (x = document.querySelector("#wide-nav")),
                  null !== x)
                ) {
      ...
      Flatsome.behavior("toggle", {
        attach: function (t) {
          ...
          jQuery(
            ...
            var t = jQuery(this).parents(".nav-slide").length
              ? "right"
              : "down";
            jQuery(this)
              .parent()
            ...
            n.e(2)
              ...
              .then(function () {
                jQuery(i).stickySidebar({
                  ...
                  jQuery(document).on(
                    "updated_checkout flatsome-infiniteScroll-append",
                    function () {

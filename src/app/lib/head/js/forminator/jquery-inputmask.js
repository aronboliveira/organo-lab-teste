...
import loadJQuery from "../jquery/jquery";

export default function loadJQueryInputMask(jQuery) {
  !(function (e, t) {
    if ("object" == typeof exports && "object" == typeof module)
      module.exports = t(jQuery);
    else if ("function" == typeof define && define.amd) define(["jquery"], t);
    else {
      if (!jQuery) jQuery = loadJQuery();
      var a = t(jQuery);
      if (typeof exports === "object") for (var i in a) exports[i] = a[i];
      else for (var i in a) e[i] = a[i];
    }
            ...
            var l = {
              ...
              off: function (e, t) {
                if (e.inputmask && e.inputmask.events) {
                  ...
                  for (var n in (t && ((i = [])[t] = e.inputmask.events[t]),
                  i)) {
              ...
              datetime: {
                ...
                onKeyDown: function (e, t, a, i) {
                  e.ctrlKey &&
                    ...
                    (this.inputmask._valueSet(y(new Date(), i)),
                    u(this).trigger("setvalue"));
                },
                onUnMask: function (e, t, a) {
                  return t
                    ? v(a.outputFormat, k(e, a.inputFormat, a), a, !0)
                    : t;
                },
              ...
              numeric: {
                ...
                onKeyDown: function (e, t, a, i) {
                  ...
                  if (
                    ...
                    if (
                      t[
                        e.keyCode === n.default.DELETE ? a.begin - 1 : a.end
                      ] === i.negationSymbol.front
                    )
                      return (
                        (r = t.slice().reverse()),
                    ...
                    for (var c = 0; c < o.length; c++)
                      if (
                        ...
                        (!0 === o[c].match.static ||
                          void 0 === r ||
                          !1 !==
                            o[c].match.fn.test(r.match.def, n, e, !0, i)) &&
                        (l.push(o[c]),
            ...
            Object.defineProperty(t, "__esModule", {
              ...
              (t.getMaskTemplate = function (e, t, a, i, s) {
                ...
                do {
                  ...
                  ((void 0 === l.maxLength || k < l.maxLength) &&
                    (!0 !== h.static || "" !== h.def)) ||
                  t > k
                );
                "" === g[g.length - 1] && g.pop();
          ...
          7215: function (e, t, a) {
              ...
              if (void 0 !== c) {
                ...
                for (
                  ...
                  for (
                    ...
                    (k = A[h]),
                    (g = o.translatePosition.call(x, g)),
            ...
            function f(e, t, a, i, r, s, d) {
              ...
              if (
                ...
                if (
                  void 0 === v.maxLength ||
                  x < o.translatePosition.call(v, v.maxLength)
                ) {
                  if (
                      ...
                      if (
                        ...
                        if (
                          (y.jitOffset[x] &&
                            ...
                            !1 !== (S = f.call(v, x + y.jitOffset[x], t, !0)) &&
                            (!0 !== r && (S.caret = x), (O = !0)),
                          ...
                          for (
                            var T = x + 1,
                              A = o.seekNext.call(v, x, !1, 0 !== x);
                            T <= A;
                            T++
                          )
                            if (!1 !== (S = E(T, t, a))) {
                              (S =
                                h.call(v, x, void 0 !== S.pos ? S.pos : T) ||
                                S),
                                (x = T);
                              break;
                            }
